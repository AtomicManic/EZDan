...
<html>
    ...
    <body class="childUserUnderParent">
        ...
        <div class="row childEditOptions">
                ...
                <div class="col-sm-4 editBtn">
                    <a href="userForm.php?childId=<?php echo $row['id']."&&button=edit";?>
                    " type="button" id="editUserBtn" class="btn btn-secondary editBtnItem">Edit</a>

                    <a href="<?php echo "services/userDelete-service.php?childId=".$row['id']; ?>" type="button" id="deleteUserBtn" class="btn btn-danger editBtnItem">Delete</a>
                </div>
                <div class="col-sm-4 editBtn">
